...
function fe() {
  return oe || (oe = 1, (function() {
    ...
    function y(e, t) {
      function r() {
        I || (I = true, console.error(
          "%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)",
          t
        ));
      }
      r.isReactWarning = true, Object.defineProperty(e, "key", {
        get: r,
        configurable: true
      });
    }
    function W() {
      var e = i(this.type);
      return k[e] || (k[e] = true, console.error(
...
var ae;
function pe() {
  return ae || (ae = 1, false ? q.exports = de() : q.exports = fe()), q.exports;
}
var d = pe();
var me = false;
...
var ge = (i) => {
  const {
    ...
    vertical: G = false
  } = i, l = !G, [h, H] = (0, import_react.useState)(
    X
  ), [U, V] = (0, import_react.useState)(false), [x, C] = (0, import_react.useState)(0), [v, B] = (0, import_react.useState)(0), g = xe((p) => C(p)), j = (0, import_react.useRef)(null), A = (0, import_react.useRef)(null), [b, I] = (0, import_react.useState)(false), k = (0, import_react.useCallback)(() => {
    A.current?.complete && j.current?.complete && I(true);
  }, []);
  (0, import_react.useEffect)(() => (k(), () => {
    I(false);
  }), [m, O, k]), (0, import_react.useEffect)(() => {
    ...
    B(p);
  }, [x, b, s]), (0, import_react.useEffect)(() => {
    if (!g.current || !b)
      return;
    const p = (r) => {
      if (!g.current)
      ...
      V(true), "touches" in r || r.preventDefault(), p(r), window.addEventListener("mousemove", p), window.addEventListener("touchmove", p);
    }, e = () => {
      V(false), window.removeEventListener("mousemove", p), window.removeEventListener("touchmove", p);
    }, t = g.current;
  ...
  return d.jsxs(d.Fragment, { children: [
    $ && !b && d.jsx("div", { style: { ...c.container }, children: $ }),
    d.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          d.jsxs("div", { style: c.slider, children: [
            d.jsx("div", { style: c.line }),
            u ? d.jsx("div", { style: c.handleCustom, children: u }) : d.jsxs("div", { style: c.handleDefault, children: [
              d.jsx("div", { style: c.leftArrow }),
              d.jsx("div", { style: c.rightArrow })
            ] }),
            d.jsx("div", { style: c.line })
          ] }),
          W && d.jsx("div", { style: c.leftLabelContainer, children: d.jsx("div", { style: c.leftLabel, children: W }) }),
          T && d.jsx("div", { style: c.rightLabelContainer, children: d.jsx("div", { style: c.rightLabel, children: T }) })
        ]
      }
    )
  ] });
...
react-compare-image/dist/ReactCompareImage.mjs:
  (**
   * @license React
